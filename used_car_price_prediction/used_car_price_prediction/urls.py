...
from used_car_price_prediction  import settings
...
urlpatterns = [
    ...
    url(r'^predict_used_car_price_type/$', remoteuser.predict_used_car_price_type, name="predict_used_car_price_type"),
    ...
    url(r'^Find_Used_Car_Price_Type_Ratio/$', serviceprovider.Find_Used_Car_Price_Type_Ratio, name="Find_Used_Car_Price_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Prediction_Of_Used_Car_Price/$', serviceprovider.View_Prediction_Of_Used_Car_Price, name="View_Prediction_Of_Used_Car_Price"),
