...
--
-- Host: localhost
-- Generation Time: Oct 11, 2022 at 07:10 AM
...
--
CREATE DATABASE IF NOT EXISTS `used_car_price_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `used_car_price_prediction`;
...
('fnv258f7vpaw659en35kluy6umq959mh', 'eyJ1c2VyaWQiOjN9:1oi9JL:-CJTFoUUWdjflfoEeL-eF7zqEEUUTGEEUW_A-VLaL2E', '2022-10-25 07:04:19.195741'),
...
('ojdzeswxy3fftm6z2btn9k267py8mhx1', 'eyJ1c2VyaWQiOjF9:1ohqtG:ts5uuzuAnC-zwXOBCwHAkOrSWgEZz_abX6kM8405d1Y', '2022-10-24 11:24:10.412308'),
...
('p7okq8d09rfeyff0q8moevdnycyhedlv', 'eyJ1c2VyaWQiOjF9:1oi91M:VjFIaxtxxStHK8pjujfXySuxeMRSIKPz_cZEjPKm318', '2022-10-25 06:45:44.322623'),
...
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#7827,4th Cross,Rajajinagar', 'Male'),
(3, 'tmksmanju', 'tmksmanju13@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Malleshwaram', 'Male');
...
(58, 'Random Forest Classifier', '80.14950166112956'),
(59, 'SVM', '80.06644518272425'),
(60, 'Logistic Regression', '80.48172757475083'),
(61, 'KNeighborsClassifier', '79.06976744186046');
...
(11, 'Below 5L', '66.66666666666666'),
(12, 'More Than 5L and Below 20L', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_price_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_price_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `RID` varchar(3000) NOT NULL,
  `Car_Name` varchar(3000) NOT NULL,
  `Location` varchar(3000) NOT NULL,
  `Car_Year` varchar(3000) NOT NULL,
  `kilometer` varchar(3000) NOT NULL,
  `Fuel_Type` varchar(3000) NOT NULL,
  `Transmission` varchar(3000) NOT NULL,
  `Owner_Type` varchar(3000) NOT NULL,
  `Mileage` varchar(3000) NOT NULL,
  `Engine` varchar(3000) NOT NULL,
  `Power` varchar(3000) NOT NULL,
  `Seats` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `remote_user_price_prediction`
--

INSERT INTO `remote_user_price_prediction` (`id`, `RID`, `Car_Name`, `Location`, `Car_Year`, `kilometer`, `Fuel_Type`, `Transmission`, `Owner_Type`, `Mileage`, `Engine`, `Power`, `Seats`, `Prediction`) VALUES
(1, '209.85.201.188-10.42.0.151-5228-53409-6', 'Hyundai Creta 1.6 CRDi SX Option', 'Pune', '2015', '41000', 'Diesel', 'Manual', 'First', '19.67 kmpl', '1582 CC', '126.2 bhp', '5', 'More Than 5L and Below 20L'),
(2, '180.76.147.97-10.42.0.211-80-60005-6', 'Honda Jazz V', 'Chennai', '2011', '46000', 'Petrol', 'Manual', 'First', '18.2 kmpl', '1199 CC', '88.7 bhp', '5', 'Below 5L'),
(3, '10.42.0.151-31.13.71.3-60663-443-6', 'Hyundai Verna Transform SX VGT CRDi', 'Ahmedabad', '2010', '70002', 'Diesel', 'Manual', 'First', '16.2 kmpl', '1493 CC', '110 bhp', '5', 'Below 5L');
